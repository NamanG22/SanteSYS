        ...
        <div>
            <section className="relative w-full bg-onyx">
                <div className="w-full relative z-content py-12 lg:py-16 2xl:py-26 max-w-full-screen mx-auto px-5 md:px-10 lg:px-12">
                    <div className="flex flex-col justify-between px-[96.4px]">
                        <div className="text-marble-100 flex w-full flex-col justify-end">
                            <h2 className="text-4xl lg:text-5xl 2xl:text-6xl font-body mb-5 md:mb-8 md:w-2/3 lg:w-3/4 mb-3">
                                <span>Developer Resources</span>
                                <br/>
                            </h2>
                        </div>
                    </div>
                    <div className="flex w-full justify-center px-[96.4px]">
                                ...
                                <div className="flex w-full max-w-[424px] !text-marble-100 flex-col">
                                    ...
                                    <div className="flex w-full flex-col gap-y-2 md:gap-y-5">
                                        <div className="flex gap-y-2 md:gap-y-5 flex-col">
                                            <div>
                                                <p className="text-3xs uppercase font-body text-marble-100">
                                                    <span>PLAYGROUND</span>
                                                    <br/>
                                                </p>
                                            </div>
                                            <p className="text-xl 2xl:text-2xl font-body">
                                                <span>Explore how the latest AI advancements can apply to your business</span>
                                                <br/>
                                            </p>
                                        </div>
                                ...
                                <div className="flex w-full max-w-[424px] !text-marble-100 flex-col">
                                    ...
                                    <div className="flex w-full flex-col gap-y-2 md:gap-y-5">
                                        <div className="flex gap-y-2 md:gap-y-5 flex-col">
                                            <div>
                                                <p className="text-3xs uppercase font-body text-marble-100">
                                                    <span>LLM UNIVERSITY</span>
                                                    <br/>
                                                </p>
                                            </div>
                                            <p className="text-xl 2xl:text-2xl font-body">
                                                <span>Get the competitive edge in generative AI with courses from LLM University</span>
                                                <br/>
                                            </p>
                                        </div>
                                        <div className="flex flex-row">
                                ...
                                <div className="flex w-full max-w-[424px] !text-marble-100 flex-col">
                                    ...
                                    <div className="flex w-full flex-col gap-y-2 md:gap-y-5">
                                        <div className="flex gap-y-2 md:gap-y-5 flex-col">
                                            ...
                                            <p className="text-xl 2xl:text-2xl font-body">
                                                <span>Start integrating Cohere’s AI models into your apps and workflows</span>
                                                <br/>
                                            </p>
                                        </div>
                                        <div className="flex flex-row">
